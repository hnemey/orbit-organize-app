...
const UnscheduledSidebar: React.FC<UnscheduledSidebarProps> = ({
  ...
  return <div className="bg-gray-900 rounded-lg shadow-sm border border-gray-700 h-[1200px] flex flex-col">
      ...
      <div className="p-6 flex-1 overflow-y-auto py-0">
        <div className="space-y-4">
          {tasks.map(task => <div key={task.id} draggable onDragStart={e => handleDragStart(e, task)} className="p-4 rounded-lg border border-gray-600 cursor-move hover:border-gray-500 hover:shadow-sm transition-all bg-gray-700">
